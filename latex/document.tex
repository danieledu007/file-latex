...
\begin{figure}[ht!]
    ...
    \caption{in questo grafico possiamo vedere l'andamento del prezzo degli stock di nvidia in base alla data con un campione di dati di 2 mesi.}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \caption{Mentre in questo possiamo vedere l'andamento del prezzo degli stock di nvidia in base alla data con un campione di dati di 5 anni.}
\end{figure}
...
In generale, Nvidia si conferma come una società in forte crescita, con un mercato azionario altamente reattivo ai cambiamenti tecnologici.
\section*{Prompt utilizzati per lo svolgimento del lavoro e il raccoglimento dei dati:}
\begin{itemize}
    \item riordinare tabella svc in excel.
    \item i got all the data in a single column divided with commas.
    \item formula regressione lineare
    \item Cerca i valori delle azioni di Nvidia negli ultimi 2 mesi
\end{itemize} 
\end{document}